// Yung nasa navbar, didisable nalang sa nav.tsx Tapos di ko mapa work yung shadcn chart
                ...
                >
                    <div className="flex items-center justify-between mb-2">
                        <div className="w-14 h-14 flex items-center justify-center">
                            <img src="/icons/solar_dollar-bold.svg" alt="Earnings" className="w-10 h-10 object-contain" />
                        </div>
                    ...
                    <div className="flex items-end gap-2">
                        <span className="text-2xl font-bold text-primary pl-4">12,100.75 PHP</span>
                        <span className="text-base text-primary/60 font-semibold">41.42 ICP</span>
                    </div>
                    <div className="text-xs text-primary/50 font-medium pl-4">Kita</div>
                </div>
                <div className="flex gap-3">
                    <div className="rounded-2xl border border-primary p-1 flex-1 flex flex-col items-start min-h-[110px]">
                        <div className="w-14 h-14 flex items-center justify-center mb-1">
                            <img src="/icons/solar_graph-up-bold.svg" alt="Graph Up" className="w-7 h-7 object-contain" />
                        </div>
                        <span className="text-xl font-bold text-accent pl-3">678</span>
                        <span className="text-xs text-primary/70 font-medium pl-3 pb-3">Nabentang Tanim</span>
                    </div>
                    <div className="rounded-2xl border border-primary p-1 flex-1 flex flex-col items-start min-h-[110px]">
                        <div className="w-14 h-14 flex items-center justify-center mb-1">
                            <img src="/icons/ri_plant-fill.svg" alt="Plant" className="w-7 h-7 object-contain" />
                        </div>
                        <span className="text-xl font-bold text-[#fcca00] pl-3">30</span>
                        <span className="text-xs text-primary/70 font-medium pl-3 pb-3">Still Available</span>
                    </div>
                </div>
            </section>
                    ...
                    <div className="h-36 flex items-end justify-center w-full">
                        <div className="w-full h-full flex items-end">
                            ...
                            <div className="absolute left-[58%] top-[20%] rounded-xl shadow px-3 py-1 flex flex-col items-center border border-primary/10 z-20 bg-[#f8f8e0]">
                                <span className="text-primary font-bold text-base">1,350.04</span>
                                <span className="text-green-600 text-xs font-semibold">+3.4%</span>
                                <span className="text-primary/50 text-xs">May 22</span>
                            </div>
                        </div>
                    </div>
                </div>
